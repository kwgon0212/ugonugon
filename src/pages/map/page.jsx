      ...
      <Main hasBottomNav={false}>
        ...
        {selectedPlace && (
          <>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-[196px] bg-white p-5 shadow-lg rounded-t-[10px] transition-all duration-500 transform translate-y-full animate-slide-up z-20">
